...
const AgendaItem: React.FC<AgendaItemProps> = ({
    ...
    return (
        <div className="flex flex-col md:flex-row md:items-center p-4 md:p-6 rounded-lg text-white my-5">
            {/* Phase Number */}
            <div className="flex flex-row items-center gap-3 border-b-2 md:border-b-0 border-gray-500">
                <div className="flex flex-col md:items-center justify-center md:px-5 p-1 md:border-b-0 md:border-r border-gray-500 pb-2 my-2 md:mb-0 md:mr-5">
